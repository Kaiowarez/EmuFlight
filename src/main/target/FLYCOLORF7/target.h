...
#define MPU_INT_EXTI                                     PC3                  //MPU_INT_EXTI
...
#define VBAT_SCALE                                       110                    //configurator tab voltage scale
...
#define USED_TIMERS ( TIM_N(1) | TIM_N(2) | TIM_N(3) | TIM_N(4)  | TIM_N(5)  | TIM_N(8) ) //update based on update CLRACINGF7 Target BF4.1+
