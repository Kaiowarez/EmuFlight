...
TEST(LQTest, TestElement_LQ_SOURCE_NONE_SAMPLES)
{
    ...
    bfOsdConfigMutable()->item_pos[OSD_LINK_QUALITY] = OSD_POS(8, 1) | OSD_PROFILE_1_FLAG;
    bfOsdConfigMutable()->link_quality_alarm = 0;
...
TEST(LQTest, TestLQAlarm)
{
    ...
    bfOsdConfigMutable()->link_quality_alarm = 80;
